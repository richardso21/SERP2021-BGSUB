...
# specify path of npy FgSegNet outputs
PTH = '../data/classifier'

# clarify other needed paths
npy_pth = os.path.join(PTH, 'FgSegNet_O', scene)
save_pth = os.path.join(os.getcwd(), 'cModel')

Path(save_pth).mkdir(exist_ok=True)
...
print(f'Commence training on {scene}!')
...
print(f'Completed training + saving on {scene}.')
