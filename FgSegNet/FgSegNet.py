...
# ==== HYPERPARAMETERS ====
scene = 'BGSUB'
num_frames = 200 # 50 # either 50 or 200 frames, default 50 frames
batch_size = 1
...
train_dir = os.path.join('../data/annotated/DS_half', 'label')
dataset_dir = os.path.join('../data/annotated/DS_half', 'raw')
